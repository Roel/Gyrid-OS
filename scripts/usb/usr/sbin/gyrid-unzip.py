...
if len(scanfiles) > 0:
    ...
    r = re.compile(r'^[0-9]{8}-[0-9]{6}-[A-Za-z]*,[0-9A-Fa-f]{12},[0-9]*,(in|out|pass)$')
...
if len(anglefiles) > 0:
    ...
    r = re.compile(r'^[0-9]{8}-[0-9]{6}-[A-Za-z]*,[0-9A-Fa-f]{12},-?[0-9]+,[0-9]{1,3}\.?[0-9]*$')
...
if len(acpfiles) > 0:
    ...
    r = re.compile(r'^[0-9]{8}-[0-9]{6}-[A-Za-z]*,[0-9A-Fa-f]{12},(in|out)$')
...
if len(drwfiles) > 0:
    ...
    r = re.compile(r'^[0-9]{8}-[0-9]{6}-[A-Za-z]*,[0-9]{4},[0-9A-Fa-f]{12},-[0-9]+$')
